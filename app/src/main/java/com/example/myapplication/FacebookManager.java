...
public class FacebookManager {
    ...
    private Call<com.example.myapplication.entities.AccessToken> call;
    ...
    private void getTokenFromBackend(String name, String email, String provider, String providerUserId){
        ...
        call.enqueue(new Callback<com.example.myapplication.entities.AccessToken>() {
            @Override
            public void onResponse(Call<com.example.myapplication.entities.AccessToken> call, Response<com.example.myapplication.entities.AccessToken> response) {
            ...
            @Override
            public void onFailure(Call<com.example.myapplication.entities.AccessToken> call, Throwable t) {
